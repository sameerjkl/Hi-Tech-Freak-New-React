      ...
      <div className="footer-gray-container">
        <div className="footer-gray-container1">
          <div className="footer-gray-container2">
            <span className="footer-gray-text">HTF&apos;s Ideas</span>
          ...
          <div className="footer-gray-container4">
            <div className="footer-gray-container5">
              ...
              <Link to="/about-us" className="footer-gray-navlink Large">
                About Us
              </Link>
              <span className="footer-gray-text03 Large">Freebies</span>
              <span className="footer-gray-text04 Large">Premium Tools</span>
            ...
            <div className="footer-gray-container6">
              ...
              <Link to="/sign-in" className="footer-gray-navlink1 Large">
                Login
              </Link>
              <span className="footer-gray-text07 Large">Register</span>
              <span className="footer-gray-text08 Large">About</span>
            </div>
            <div className="footer-gray-container7">
              <span className="footer-gray-text09 Large">
                Help &amp; Support
              </span>
              <span className="footer-gray-text10 Large">Contact Us</span>
              <span className="footer-gray-text11 Large">Knowledge Center</span>
              <span className="footer-gray-text12 Large">
                Custom Development
              </span>
              <span className="footer-gray-text13 Large">Sponsorships</span>
            </div>
        ...
        <span className="footer-gray-text18">
          All rights reserved. Copyright © 2023 Hitech Freak.
        </span>
      </div>
    </footer>
  )
