    ...
    <div className="home-container">
        ...
        <div className="home-container06">
          <div className="home-container07">
            ...
            <span className="home-text06 Small">
              ...
              <br></br>
              <span className="home-text09">-NOAA</span>
            </span>
        ...
        <div className="home-container11">
          <div className="home-container12">
            <div className="home-container13">
              <h2 className="home-text17 HeadingOne">Work with us</h2>
              <p className="home-text18 Lead">
      ...
      <section className="home-contaier">
        <div className="home-container29">
          ...
          <h2 className="home-text24 HeadingTwo">
            <span className="home-text25">Beware The Components</span>
          </h2>
          <h3 className="home-text26 HeadingTwo">
            <span className="home-text27">How To Handle Them</span>
            <br></br>
          </h3>
        ...
        <div className="home-container31">
          <div className="home-container32">
            ...
            <div className="home-container34">
              ...
              <h1 className="home-text30 HeadingOne">Search and Discover!</h1>
        ...
        <div className="home-container36">
          ...
          <div className="home-container38">
            ...
            <div className="home-container40">
              ...
              <h1 className="home-text34 HeadingOne">Talk and Meet!</h1>
