    ...
    <div className="home-container">
        ...
        <div className="home-container11">
          <div className="home-container12">
            <div className="home-container13">
              <h2 className="home-text21 HeadingOne">Work with us</h2>
              <p className="home-text22 Lead">
                <span className="home-text23">
                  Whatever your qualification is - we got you!
                </span>
              </p>
              <p className="home-text24 Body">
              ...
              <p className="home-text26">Mark Jojansen</p>
              <p className="home-text27 Small">Project manager, Atlassian</p>
      ...
      <section className="home-contaier">
        <div className="home-container29">
          ...
          <h2 className="home-text28 HeadingTwo">
            <span className="home-text29">Beware The Components</span>
          </h2>
          <h3 className="home-text30 HeadingTwo">
            <span className="home-text31">How To Handle Them</span>
            <br></br>
          </h3>
        ...
        <div className="home-container31">
          <div className="home-container32">
            ...
            <div className="home-container34">
              ...
              <h1 className="home-text34 HeadingOne">Search and Discover!</h1>
        ...
        <div className="home-container36">
          ...
          <div className="home-container38">
            ...
            <div className="home-container40">
              ...
              <h1 className="home-text38 HeadingOne">Talk and Meet!</h1>
