...
const Profile = (props) => {
  return (
    <div className="profile-container">
      <Helmet>
        <title>Profile - Hi-Tech Freak New</title>
        <meta property="og:title" content="Profile - Hi-Tech Freak New" />
      </Helmet>
      ...
      <FooterGray rootClassName="footer-gray-root-class-name2"></FooterGray>
    </div>
  )
}
